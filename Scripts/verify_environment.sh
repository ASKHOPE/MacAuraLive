...
UPDATE_VER=$(grep -o 'currentVersion = "1.2.0"' Sources/MacAuraLive/Core/UpdateManager.swift || true)
...
if [ $ERRORS -eq 0 ]; then
    echo "  ✅ App name 'MacAuraLive' and version '1.2.0' are 100% synchronized."
fi
